...
@section('menu')
@parent
<li class="nav-item m-5"><a href="#" class="nav-link">Historial</a></li>
@endsection
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" >
				...
				?>
            <!-- Mapa desplegable -->
            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">Abrir Mapa</button>
