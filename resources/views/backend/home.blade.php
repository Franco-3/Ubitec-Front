        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    <li class="nav-item"><a class="nav-link link text-black display-4" href="#nosotros">Sobre Nosotros</a></li>
                    <li class="nav-item"><a class="nav-link link text-black display-4" href="#servicios">Servicios</a></li>
                    <li class="nav-item"><a class="nav-link link text-black display-4" href="#contacto">Contactos</a></li>
                    <li class="nav-item"><a class="nav-link link text-black display-4" href="{{route('login')}}">Iniciar sesion</a></li>
                </ul>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6">
                <div class="card-wrapper">
                    <div class="card-box align-left">
                        <h4 class="card-title mbr-fonts-style mb-4 display-2"><strong>Porque Ubitec?</strong>
                        </h4>
            ...
            <div class="col-12 col-lg-6">
                <div class="item mbr-flex">
                    ...
                    <div class="text-box">
                        <h4 class="icon-title mbr-black mbr-fonts-style display-7"><strong>En cualquier lugar</strong></h4>
                        <h5 class="icon-text mbr-black mbr-fonts-style display-4">Puedes usar Ubitec en cualquier parte del mundo.</h5>
                    </div>
                </div>
                <div class="item mbr-flex">
                    <div class="icon-box">
                    ...
                    <div class="text-box">
                        <h4 class="icon-title mbr-black mbr-fonts-style display-7"><strong>Adaptabilidad</strong></h4>
                        <h5 class="icon-text mbr-black mbr-fonts-style display-4">Usa Ubitec en tu computadora, tablet o celular.</h5>
                    </div>
                </div>
                <div class="item mbr-flex">
                    <div class="icon-box">
                    ...
                    <div class="text-box">
                        <h4 class="icon-title mbr-black mbr-fonts-style display-7"><strong>Para usuarios y empresas</strong></h4>
                        <h5 class="icon-text mbr-black mbr-fonts-style display-4">Ofrecemos diferentes servicios segun tus necesidades.</h5>
                    </div>
                </div>
            </div>
        </div>
...
<section data-bs-version="5.1" class="content13 cid-tRPcfI4f6Q" id="content13-5">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style mb-4 display-5"><strong>Preguntas frecuentes</strong></h3>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-6">
                        <ul class="list mbr-fonts-style display-7">
                            <li><strong>Es gratis el servicio?</strong><br>Es gratis para uso personal, puedes usar el servicio con un limite de 35 direcciones en cada ruta. Para empresas puedes ver los precios a continuacion.</li>
                            <li><strong>Cuales son los beneficios?</strong><br>Tenemos un rango amplio de beneficios que se pueden conseguir al utilizar la aplicacion, alguno de ellos son: ahorro de tiempo, ahorro de combustible.</li>
                            <li><strong>Tienen una aplicacion para android - IOS?</strong><br>De momento no contamos con aplicaciones moviles disponibles, pero estamos trabajando constantemente para lograrlo.</li>
                        </ul>
                    </div>
                    <div class="col-12 col-lg-6">
                        <ul class="list mbr-fonts-style display-7">
                            <li><strong>Puedo compartir mi cuenta?
                                </strong><br>Esta totalmente prohibido en condiciones de servicio compartir cuentas con otros usuarios finales, cada usuario es exclusivamente para uso perosnal.&nbsp;</li>
                            <li><strong>Que pasa&nbsp; si pierdo la conexion?<br></strong>Aunque nuestro servicio funciona de forma web, antes de perder la conexion puedes descargar un excel con la solucion de la ruta que creaste.&nbsp;</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<section data-bs-version="5.1" class="features3 cid-tRPc8zWHj3" id="features3-4" >


    <div class="container" id="servicios">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Comienza ahora</strong></h4>
        ...
        <div class="row mt-4">
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-6 active">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/steering-wheel-4059377-1280-1256x836.jpg" alt="Mobirise Website Builder" data-slide-to="0" data-bs-slide-to="0">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Para individuos</strong></h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/production-4408573-1280-1256x837.jpg" alt="Mobirise Website Builder" data-slide-to="1" data-bs-slide-to="1">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Para una flota de&nbsp;vehículos</strong></h5>
    ...
    <div class="container" id="hidden-container-user">
        <div class="row justify-content-center">
                    ...
                    <div class="plan-body">
                        <div class="plan-list mb-4">
                            <ul class="list-group mbr-fonts-style list-group-flush display-7">
                                <li class="list-group-item">Enrutamiento eficaz</li><li class="list-group-item">Hasta 30 direcciones por día</li><li class="list-group-item">Sin anuncios</li>
                            </ul>
                        </div>
                        <div class="mbr-section-btn text-center">
            ...
            <div class="col-12 col-md-6 align-center col-lg-4">
                <div class="plan">
                    <div class="plan-header">
                        <h6 class="plan-title mbr-fonts-style mb-3 display-5"><strong>Mensual</strong></h6>
                        <div class="plan-price">
                            <p class="price mbr-fonts-style m-0 display-1"><strong>$9</strong></p>
                            <p class="price-term mbr-fonts-style mb-3 display-7"><strong>Por mes</strong></p>
                        </div>
                    </div>
                    <div class="plan-body">
                        <div class="plan-list mb-4">
                            <ul class="list-group mbr-fonts-style list-group-flush display-7">
                                <li class="list-group-item">Enrutamiento eficaz</li><li class="list-group-item">Hasta 200 direcciones por día</li><li class="list-group-item">Historial de rutas</li><li class="list-group-item">Sin anuncios</li>
                            </ul>
                        </div>
                        <div class="mbr-section-btn text-center">
                            <a href="https://mobiri.se" class="btn btn-primary display-4">Get started</a>
            ...
            <div class="col-12 col-md-6 align-center col-lg-4">
                <div class="plan">
                    ...
                    <div class="plan-body">
                        <div class="plan-list mb-4">
                            <ul class="list-group mbr-fonts-style list-group-flush display-7">
                                <li class="list-group-item">Enrutamiento eficaz</li><li class="list-group-item">Hasta 250 direcciones por día</li><li class="list-group-item">Historial de rutas</li><li class="list-group-item">Sin anuncios</li>
                            </ul>
                        </div>
                        <div class="mbr-section-btn text-center">
    ...
    <div class="container" id="hidden-container-empresa">
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 align-center col-lg-3">
                <div class="plan">
                    <div class="plan-header">
                        <h6 class="plan-title mbr-fonts-style mb-3 display-5"><strong>Mensual 1</strong></h6>
                        <div class="plan-price">
            ...
            <div class="col-12 col-md-6 align-center col-lg-3">
                <div class="plan">
                    <div class="plan-header">
                        <h6 class="plan-title mbr-fonts-style mb-3 display-5"><strong>Mensual 2</strong></h6>
                        <div class="plan-price">
                            <p class="price mbr-fonts-style m-0 display-1"><strong>$95</strong></p>
                            <p class="price-term mbr-fonts-style mb-3 display-7"><strong>Por mes</strong></p>
                        </div>
                    </div>
                    <div class="plan-body">
            ...
            <div class="col-12 col-md-6 align-center col-lg-3">
                <div class="plan">
                    <div class="plan-header">
                        <h6 class="plan-title mbr-fonts-style mb-3 display-5"><strong>Mensual 3</strong></h6>
                        <div class="plan-price">
                            <p class="price mbr-fonts-style m-0 display-1"><strong>$190</strong></p>
                            <p class="price-term mbr-fonts-style mb-3 display-7"><strong>Por mes</strong></p>
                        </div>
                    </div>
                    <div class="plan-body">
            ...
            <div class="col-12 col-md-6 align-center col-lg-3">
                <div class="plan">
                    <div class="plan-header">
                        <h6 class="plan-title mbr-fonts-style mb-3 display-5"><strong>Mensual 4</strong></h6>
                        <div class="plan-price">
                            <p class="price mbr-fonts-style m-0 display-1"><strong>$495</strong></p>
                            <p class="price-term mbr-fonts-style mb-3 display-7"><strong>Por mes</strong></p>
                        </div>
                    </div>
                    <div class="plan-body">
                        <div class="plan-list mb-4">
                            <ul class="list-group mbr-fonts-style list-group-flush display-7">
                                <li class="list-group-item">Enrutamiento eficaz</li>
                                <li class="list-group-item">Hasta 100 vehículos</li>
...
<section data-bs-version="5.1" class="contacts2 cid-tRPhe58FwI" id="contacts2-b" >
    ...
    <div class="container" id="contacto">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Contáctanos&nbsp;ahora</strong></h3>
...
<section data-bs-version="5.1" class="footer3 cid-tRPgCBzJW3" once="footers" id="footer3-7">
