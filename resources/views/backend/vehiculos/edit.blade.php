            ...
            <div class="p-4 border border-primary rounded">
                ...
                <div class="links">
                    ...
                    <div class="coolinput mb-3 @if ($errors->has('titulo')) has-error has-feedback @endif">
                        {{ Form::label('nombre', 'Nombre', ['class' => 'control-label text']) }}
                        {{ Form::text('nombre', $vehiculo->nombre, ['class' => 'form-control input', 'placeholder' => 'Ingrese el nombre']) }}
                        @error('nombre')
                    ...
                    <div class="coolinput mb-3">
                        ...
                        {{ Form::text('patente', $vehiculo->patente, ['class' => 'form-control input', 'maxlength' => '7']) }}
                        @error('patente')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
