    ...
    <div class="high-gloss"
         style="
         background-image: linear-gradient(rgba(50, 50, 50, 0.95) 24%, rgb(186, 186, 186) 45%, rgba(226, 235, 238, 0.953) 49%, rgba(50, 50, 50, 0.93) 50%, rgba(50, 50, 50, 0.97) 100%);
         block-size: 32px;
        ...
        There's a lot of style here</div>
